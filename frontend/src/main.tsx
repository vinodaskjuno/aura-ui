...
// --font-mono has always named JetBrains Mono; it was never actually shipped, so every
// mono surface in the app silently fell back to whatever the OS defaults to.
